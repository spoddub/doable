...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/floraison/fugit/issues", "changelog_uri" => "https://github.com/floraison/fugit/blob/master/CHANGELOG.md", "documentation_uri" => "https://github.com/floraison/fugit", "homepage_uri" => "https://github.com/floraison/fugit", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/floraison/fugit" } if s.respond_to? :metadata=
